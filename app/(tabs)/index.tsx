...
export default function AttendanceScreen() {
  ...
  const [locationAddress, setLocationAddress] = useState<string>('Mengambil lokasi...');
      ...
      <View style={styles.permissionContainer}>
        ...
        <View style={styles.permissionContent}>
          <View style={styles.permissionIconContainer}>
            <Ionicons name="camera-outline" size={48} color={BrandColors.navy} />
          </View>
    ...
    return (
      <View style={styles.previewContainer}>
        ...
        <View style={styles.previewHeader}>
          ...
          >
            <Ionicons name="arrow-back" size={24} color={NeutralColors.slate800} />
          </TouchableOpacity>
        ...
        <View style={styles.infoCard}>
          <View style={styles.infoRow}>
            <View style={[styles.infoIcon, { backgroundColor: SemanticColors.infoBg }]}>
              <Ionicons name="location" size={18} color={SemanticColors.info} />
            </View>
          ...
          <View style={styles.infoRow}>
            <View style={[styles.infoIcon, { backgroundColor: SemanticColors.successBg }]}>
              <Ionicons name="time" size={18} color={SemanticColors.success} />
            </View>
            <View style={styles.infoTextContainer}>
          ...
          {isSaving ? (
            ...
            <>
              <TouchableOpacity 
                ...
                activeOpacity={0.8}
              >
                <Ionicons name="refresh-outline" size={20} color={NeutralColors.slate700} />
                <Text style={styles.retakeButtonText}>Foto Ulang</Text>
              </TouchableOpacity>
              
              <TouchableOpacity onPress={handleSaveAttendance} activeOpacity={0.8}>
                <LinearGradient
    ...
    <View style={styles.container}>
      ...
      <CameraView style={styles.camera} ref={cameraRef} facing="front">
        ...
        >
          ...
          <Text style={styles.captureHint}>Posisikan wajah dalam bingkai, lalu tekan tombol</Text>
        </LinearGradient>
      </CameraView>
    </View>
  );
